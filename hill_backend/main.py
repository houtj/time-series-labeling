...
# @app.post("/dataitem")
# async def save_file(file: UploadFile, project_id: str):
#     ## add new label
#     new_label = {
#         'label_json': ''
#     }
#     result = db.labels.insert_one(new_label)
#     new_label_id = result.inserted_id
#     ## add new dataitem
#     dataitem_name = file.filename
#     new_dataitem = {
#         'name': dataitem_name,
#         'creationTime': datetime.new(tz=timezone.utc),
#         'labelMeta': {
#             'id': new_label_id,
#             'nbManualLabels': 0,
#             'nbAutoLabels': 0,
...
#     }
#     result = db.dataitems.insert_one(new_dataitem)
#     new_dataitem_id = result.inserted_id
#     project_info = db.projects.find_one({'_id': project_id})
#     new_dataitem_in_project = {
#         'id': new_dataitem_id,
#         'name': dataitem_name,
#         'labeledBy': [],
#         'status': 'new',
...
# class NewDataitemInfo(BaseModel):
#     name: str

# @app.post("/dataitem")
# async def insert_dataitem(project_id: str, dataitem_info: Dataitem):
#     new_dataitem = {
#         'name': dataitem_info.name
#     }
#     result = db.dataitems.insert_one(new_dataitem)
#     new_dataitem_id = result.inserted_id
#     project_info = db.projects.find_one({'_id': project_id})
...
#         'status': 'new'
#     }
#     project_info['dataitems'].append(new_dataitem)
#     db.projects.find_one_and_update({'_id': project_id}, )
...
#         try:
#             project_info = db.projects.find_one({'_id': project_id})
#             await websocket.send_json(project_info)
#             time.sleep(10)
#         except WebSocketDisconnect:
#             br
