"""
Auto-Detection Package - Multi-agent AI-powered automatic event labeling system
"""
...
from .multi_agent import run_multi_agent_detection, AgentCoordinator
...
async def run_auto_detection(file_id: str, description: str = "Auto-detection requested", notification_callback=None):
    ...
    try:
        ...
        # Convert to DataFrame for analysis using the parsing.py schema
        # [{'x': True/False, 'name': 'channel_name', 'data': [values...], 'unit': 'unit', 'color': 'color'}]
